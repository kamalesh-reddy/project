...
${name}
<br>
<a href="enrollcourse">enroll for course</a><br>
<a href="generatetest">take a test</a><br>
<!-- <a href="#">view a course</a><br> -->
${msg}
...
<center>${msg}</center>
    ...
    <section class="py-5">
      <div class="container" align="center">
        <h1></h1>
        <!-- <a href="enrollcourse"><input type="button" id="enroll"  class="" value="ENROLL COURSE" background-color="blue"></a> -->
		  <a href="enrollcourse">Enroll</a>
		  <a href="generatetest">Take a Test</a>
		 <!-- <a href="generatetest"> <input type="button" id="start"  class="" value="START TEST" background-color="blue"></a> -->
